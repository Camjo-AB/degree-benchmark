...
public class RabbitMqBenchmarkProducerEnhanced implements BenchmarkProducer {
    ...
    public RabbitMqBenchmarkProducerEnhanced(Channel channel, String exchange, boolean messagePersistence,
    ...
    public CompletableFuture<Void> sendAsync(Optional<String> key, byte[] payload) {
        ...
        BasicProperties.Builder builder = defaultProperties.builder()
                .headers(Collections.singletonMap(RabbitMqBenchmarkDriverEnhanced.TIMESTAMP_HEADER, currentTimeNanos));
