...
public class RabbitMqBenchmarkProducer implements BenchmarkProducer {
    ...
    public RabbitMqBenchmarkProducer(
            Channel channel,
            String exchange,
                            ...
                            synchronized (ackSet) {
                                for (Iterator iterator = treeHeadSet.iterator(); iterator.hasNext(); ) {
                                    ...
                                    if (future != null) {
                                        ...
                                        future.completeExceptionally(nullexception);
    ...
    public CompletableFuture<Void> sendAsync(Optional<String> key, byte[] payload) {
        ...
        BasicProperties.Builder builder =
                defaultProperties
                        .builder()
                        .headers(
                                Collections.singletonMap(
                                        RabbitMqBenchmarkDriver.TIMESTAMP_HEADER, currentTimeNanos));
